...
<body>
<form method="post">
<p>课程名<input type="text" name="cname" value="${course.cname }">
<p>时间<input  type="text" name="c_time" value="${course.c_time}">
<p>授课教师<c:forEach var="ct" items="${course.ct}">
	<input  type="text" name="tid" value="${ct.teacher.tid}">
	<input type="text" name="tname" value="${ct.teacher.tname}">
</c:forEach>
